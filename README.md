...
18) [1차] 비밀지도 (9월 14일 – 9월 20일 완료)<br>
- Integer.toBinaryString(); // 정수를 이진수 스트링 형태로 바꿔주는 함수
- String.format(%5s,111); // 문자열 받아주는 형식을 지정해주는 함수
...
20) 시저 암호 (9월 14일 – 9월 20일 완료)<br>
- Character.isLowerCase(ch) 문자가 소문자,대문자인지 판단
- 문자가 시작점에서 얼마나 떨어져있냐를 판단
21) 약수의 합 (9월 14일 – 9월 20일 완료) <br>
22) 이상한 문자 만들기 (9월 21일 – 9월 27일 완료)<br>
23) 자릿수 더하기 (9월 21일 – 9월 27일 완료)<br>
24) 자연수 뒤집어 배열로 만들기 (9월 21일 – 9월 27일 완료)<br>
25) 정수 내림차순으로 배치하기 (9월 21일 – 9월 27일 완료)<br>
26) 예산 (9월 21일 – 9월 27일 완료)<br>
27) 정수 제곱근 판별 (9월 28일 - 10월 4일 완료) <br>
28) 제일 작은 수 제거하기 (9월 28일 - 10월 4일 완료) <br>
29) 짝수와 홀수 (9월 28일 - 10월 4일 완료) <br>
30) 키패드 누르기 (9월 28일 - 10월 4일 완료) <br>
31) 최대공약수와 최대공배수 (9월 28일 - 10월 4일 완료) <br>
32) 콜라츠 추측
33) 평균 구하기
34) 하샤드 수
35) 핸드폰 번호 가리기
